...
class MaskParams:
    ...
    """Які класи моделі вважати шкірою. Змінне НАВМИСНО: «шкіра» — це не
    властивість пікселя, а рішення фотографа під конкретний кадр. Ланцюжок
    на грудях лежить у класі neck і законно вважається шкірою, але
    ретушувати його не треба — знімається галочка з neck, і питання
    закрите. Модель дає класи, людина каже, що з ними робити."""
